...
```
# Generic Swap
For the above `swap` implementations, we've known the type of the data we wanted to swap. Because we knew the type, the compiler knew the sizes of the data we wanted to swap. 
